[react-query-firebase](../../../../globals.md) / [RN](../index.md) / FirebaseContextProviderProps
...
Defined in: [src/react-native/context/FirebaseContextProvider.tsx:74](https://github.com/vpishuk/react-query-firebase/blob/ff47b09d796de5dcfb13cebc11b03ede10a6bacf/src/react-native/context/FirebaseContextProvider.tsx#L74)
...
```ts
optional authPersistenceType: "SESSION" | "LOCAL" | "NONE" | "COOKIE";
```
